...
const bullet_animation_rid = await ResourceManager.load('../../assets/sprites/orb.animation')
const bullet_image_rid = await ResourceManager.load('../../assets/sprites/orb.png')
