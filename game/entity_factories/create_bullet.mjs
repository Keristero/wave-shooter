...
const bullet_animation_rid = await ResourceManager.load('../../docs/assets/sprites/orb.animation')
const bullet_image_rid = await ResourceManager.load('../../docs/assets/sprites/orb.png')
